...
- **ps2exe path fix** — EXE now correctly detects its own directory as default scan path
- **Version increment fix** — Auto-versioning now checks both .txt and .md exports
...
### Changed
- Script reduced from 1,207 to ~850 lines (-30%)
